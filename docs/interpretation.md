...
the reference, target BED, confident BED, and normalized VCFs loaded. Color reads
by strand and inspect mapping/base qualities, clipping, nearby indels, read-end
